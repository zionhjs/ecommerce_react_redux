          ...
          <View style={ styles.item_price }>
            <View style={ styles.item_price_left }>
              <Text style={ [{ color: colors.main }] }>
                { item['exchange_money'] ? `￥${ Foundation.formatPrice(item['exchange_money']) } + `  : '仅需' }{ item['exchange_point'] }积分
              </Text>
              <Text style={ styles.item_price_orig }>￥{ Foundation.formatPrice(item['goods_price']) }</Text>
            </View>
