...
class ToastContainer extends Component {
    ...
    render() {
        ...
        if (type !== types.INFO) {
            let iconName = ''
            switch (type) {
                case types.WARNING: iconName = 'ios-information-circle-outline'; break
                case types.ERROR: iconName = 'ios-close-circle-outline'; break
                default: iconName = 'ios-checkmark-circle-outline'; break
            }
            content.splice(0, 0, <Icon key="toast_icon" name={iconName} size={30} color="#FFF"/>)
        }
