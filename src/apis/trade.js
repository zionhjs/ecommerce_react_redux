 ...
 * 创建订单
 */
export function createTrade(client,way) {
  return request({
    url: 'trade/create',
    method: Method.POST,
    needToken: true,
 ...
 * @returns {*|*}
 */
export function initiateAppPay(trade_type, sn, params) {
  return request({
    url: `order/pay/app/${trade_type}/${sn}`,
    method: Method.GET,
    needToken: true,
    params
  })
 ...
 * 不参加促销活动
 */
export function cleanActivity(params) {
  return request({
    url: 'trade/promotion',
    method: Method.DELETE,
    needToken: true,
